        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text('File', style: TextStyle(color: Colors.grey, ),),
                Container(margin: EdgeInsets.only(top: 3.0),
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text('Alternate File', style: TextStyle(color: Colors.grey, ),),
                Container(margin: EdgeInsets.only(top: 3.0),
                    child: Text(userMap['alternateFile']==null?'N/A':'${userMap['alternateFile']}' , style: TextStyle(),)
                )
              ],),
          ),
          Container(
