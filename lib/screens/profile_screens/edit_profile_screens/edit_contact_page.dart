...
import 'package:file/bloc_patterns/edit_profile_bloc_patterns/edit_contact_bloc.dart';
...
class _EditContactPageState extends State<EditContactPage> {
  ...
  _EditContactPageState({this.userMap}) {
    ...
    _alternateFileTextEditingController.text =
        userMap['alternateFile'] == null ? '' : userMap['alternateFile'];
  ...
  TextEditingController _mobileTextEditingController = TextEditingController(),
      ...
      _alternateFileTextEditingController = TextEditingController(),
                      ...
                      children: <Widget>[
                        ...
                        Container(
                            ...
                            child: TextFormField(
                                ...
                                autovalidate: true,
                                controller:
                                    _alternateFileTextEditingController,
                                validator: (String value) {
                                  if (value != '' &&
