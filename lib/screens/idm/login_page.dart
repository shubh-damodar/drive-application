...
import 'package:file/bloc_patterns/idm_bloc_patterns/login_bloc.dart';
...
class _LoginPageState extends State<LoginPage> {
              ...
              child: Column(children: <Widget>[
                ...
                ButtonTheme(
                  ...
                  child: RaisedButton(
                      ...
                      onPressed: () {
                        // _loginBloc.checkLogin("gaurav", "gaurav123");
                        // _navigationActions.navigateToScreenWidget(FilePage());
                ...
                //       onTap: () {
                //         //print(
                //         //   '~~~ widget.previousScreen: ${widget.previousScreen}');
  ...
  Widget _loginFinished(mapResponse) {
    Future.delayed(Duration.zero, () {
      _loginBloc.loginStreamSink.add(null);
      if (mapResponse["message"] == "User Exists") {
        // _widgetsCollection.showMessageDialog();
        _navigationActions.navigateToScreenWidgetRoot(OtpVerification(
          userName: _usernameTextEditingController.text,
          password: _passwordTextEditingController.text,
        ));
        // _navigationActions.navigateToScreenNameRoot('otp_page');
      } else {
        _widgetsCollection.showToastMessage("Invalid Credentials");
      }
    });
    return Container(
      width: 0.0,
  ...
  //           widget.previousScreen == 'otp_page') {
